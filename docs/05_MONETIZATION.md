...
The near-term commercial test is the **Creator Signal Desk**, a manually delivered 14-day founding pilot for independent creators and publications actively covering GTA VI or closely related Rockstar stories. Five slots are offered at $99 each. A pilot includes a source-linked change brief, three content angles, safe claim wording, an unresolved-claim list, and one custom rumor check.

The first cohort is intentionally narrow. Job postings, funding, headcount growth, and broad "gaming" adjacency are not buyer signals. A prospect must already serve an audience that cares about GTA VI, publish original work on an active cadence, have a specific near-term publishing use case, and provide a stated public business route. The mandatory gate is `docs/16_GTA_VI_PROSPECT_QUALIFICATION.md`.
