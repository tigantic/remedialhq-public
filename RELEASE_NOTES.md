...
- Google Artifact Analysis APIs are enabled. The workflow waits for Google scanning and rejects an image unless analysis and SBOM generation complete with zero effective Critical and High findings.
