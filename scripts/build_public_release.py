...
PUBLIC_FILE_PATHS = frozenset(PUBLIC_ROOT_FILES | PUBLIC_ARTIFACT_PATHS | {
    ...
    "brand/youtube-video-watermark-current.png",
    ...
    "content/acquisition/gta-vi-coverage-planning-sheet.md",
    ...
    "docs/15_OWNER_CREDENTIAL_MATRIX.md",
    "docs/16_GTA_VI_PROSPECT_QUALIFICATION.md",
    ...
    "src/remedialhq/outreach_drafts.py",
    ...
    "tests/test_contact_evidence.py",
...
def _owner_identity_patterns(
    ...
    for label, keys in (
        ...
        ("private cloud project number", ("google", "gcp_project_number")),
