...
Artifact Analysis scanning is active. The first provenance-bearing v0.7.0 audit candidate was rejected with 7 Critical and 44 High findings and was never deployed. The v0.7.1 source line requires exact-image Syft inventory plus clean Trivy and Grype reports. Production services remain private, manually held at zero instances, and pinned to the earlier v0.6.1 digest until the remote provenance, attestation, signing, Google scan, smoke-test, and rollout gates execute successfully.
