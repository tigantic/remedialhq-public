...
Pin production images by digest, use GitHub Workload Identity Federation for Google Cloud deployment, protect `main`, review dependency updates, and verify the release manifest before deployment.
